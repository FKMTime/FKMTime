...
interface JudgeRankingCardProps {
    data: JudgeRankingEntry[];
}

const JudgeRankingCard = ({ data }: JudgeRankingCardProps) => {
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Most judged attempts</CardTitle>
            </CardHeader>
            <CardContent>
...
export default JudgeRankingCard;
