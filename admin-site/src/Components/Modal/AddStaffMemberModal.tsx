...
const AddStaffMemberModal: React.FC<AddStaffMemberModalProps> = ({isOpen, onClose}): JSX.Element => {
        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Add staff member">
            <Box display="flex" flexDirection="column" gap="5" as="form" onSubmit={handleSubmit}>
                <FormControl>
                    ...
                    <Input placeholder='Name' disabled={isLoading} name="name"/>
                </FormControl>
                <FormControl isRequired>
                    <FormLabel>Gender</FormLabel>
                    <Select placeholder='Select gender' _placeholder={{color: "white"}} name="gender"
                            disabled={isLoading}>
