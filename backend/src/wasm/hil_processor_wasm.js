/* @ts-self-types="./hil_processor_wasm.d.ts" */
 ...
 * @returns {WasmState}
 */
function init(log_func, initial_status) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./hil_processor_wasm_bg.js": import0,
    };
}
...
const wasmPath = `${__dirname}/hil_processor_wasm_bg.wasm`;
